...
| 9 | `feature/ai-assistant` | AI Assistant module | Dashboard Insights, Smart Search, Reports, gated Clinical Notes/Treatment Suggestions | **Merged** 2026-07-31 (`644fed6`); **fully removed 2026-08-14** — see `remove/ai-assistant` and `CHANGELOG.md`'s "Removed — AI Assistant module" |
...
| 11 | `feature/ai-assistant-api-key` | Settings-managed Anthropic API key | Encrypted key column, `AiAssistantService::client()` prefers it over `.env` | **Merged** 2026-08-02; **fully removed 2026-08-14** along with the rest of AI Assistant |
