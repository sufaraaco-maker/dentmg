...
| 32 | `feature/patient-profile-phase2-6b-timeline-ui` | Phase 2.6b — Timeline UI | `ActivityTimeline.vue`, `patientActivities` store, `timeline` tab, Billing's Payment History wiring, Overview preview, category chips, i18n | **Open as PR #32** — CI pending |
...
|---|---|---|---|---|---|
| 1 | **Merge Phase 2.6b: Timeline UI** | Implemented on `feature/patient-profile-phase2-6b-timeline-ui` (`ActivityTimeline.vue`, `timeline` tab, Billing's Payment History wiring, Overview preview, i18n), opened as **PR #32** — merging it closes out Phase 2 (Patient Profile Redesign) entirely | High — the last remaining piece of Phase 2 | Small — implementation done, awaiting CI + merge | None |
...
for this suite. Opened as **PR #32** — merging it completes Phase 2 (Patient Profile Redesign) in full.
